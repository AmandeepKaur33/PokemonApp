...
const PokemonCards = ({cardItem}) => {
  return (
    <div className='w-11/12 sm:w-1/4 h-44 cursor-pointer  flex transition-all group hover:scale-125 '>
      ...
      <h1 className='text-lg text-green-100 group-hover:text-green-500'>{cardItem?.name}</h1>
        </div>
      </div>
    </div>
  )
